...
export type { Tokens, Aliases, AliasesProps, ICustomConfig, ICustomComponents, IStyledPlugin, IStyled, IAnimationDriverPlugin, GSConfig, IAnimationResolver, } from './types';
...
export { createConfig, createComponents, } from './createConfig';
export * from './core';
export * from './hooks';
